\begin{figure}
	...
	\node[transitiontext] (p1) at ($(raw) + (0,-1.5)$) {Phase 1};
	...
	\node[transitiontext] (p2) at ($(p1) + (0,-3)$) {Phase 2};
	...
	\node[transitiontext] (p3) at ($(p2) + (0,-3)$) {Phase 3};
	...
	\end{tikzpicture}
	\caption{The data flow of algorithm~\ref{algorithm:main} modelled as a Petri net with collapsed phases.}
