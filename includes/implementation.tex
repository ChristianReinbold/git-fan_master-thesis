...
% im Prinzip überflüssig. Fasse das damit zusammen, wenn die Funktionsweise der WE erklärt wird

% pnet compiler, xml-syntax
% details of the workflow engine with petri nets in mind and its interplay with the drts - transitions should have no side effects
\cite{petri_net_wms}
